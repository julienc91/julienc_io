...
test.describe("Contact page", () => {
  test("should load successfully", async ({ page }) => {
    ...
    await expect(page).toHaveTitle(
      /Contact | Julien Chaumont - Software Engineer/,
    )
    ...
    await expect(stackOverflowLink).toHaveAttribute(
      "href",
      "https://stackoverflow.com/users/2679935/julienc",
    )
    ...
    await expect(linkedinLink).toHaveAttribute(
      "href",
      "https://www.linkedin.com/in/julien-chaumont/",
    )
